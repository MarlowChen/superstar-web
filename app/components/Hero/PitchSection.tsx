  ...
  return (
    ...
    >
      <div className="space-y-6 leading-8 text-[15px] text-slate-200">
        ...
        {/* 使命宣言 */}
        <p>
          PSF Yours 的使命，是將您的「AI負債」轉化為「專有AI資產」。我們不提供SaaS服務，我們為您鑄造專屬於您的數位資產。
        </p>
        ...
        <ol className="list-decimal pl-6 space-y-3">
          ...
          <li>
            數據隔離與純淨： 您的創意與需求不再受制於通用大模型的規範與限制。OpenAI等巨頭會將所有數據混在一起訓練，造成數據污染與風格干擾。PSF Yours 採用LoRA、強化學習（RL）、監督微調（SFT）等技術，為您的角色、場景、物件、功能打造獨立專屬的小模型，確保數據純淨，風格一致。
          </li>
          <li>
        ...
        <p>
          PSF Yours 的定位，就是成為AI圖像生成界的TSMC。我們不自己設計晶片（基底模型），但我們擁有最獨特的「製造工藝」。
        </p>
        <p>
          我們採用最先進的開源模型，用我們獨有的數據清洗、訓練策略和工作流整合技術，為您「代工」出一顆顆體積微小、效能強大、且完全客製化的「AI晶片」（您的專屬模型）。
        </p>
        <p>
          這顆晶片（PSF 模型），只為您服務，也可只在您的設備上運行，只屬於您專有。
        </p>
        <p>這就是PSF Yours為您打造的專屬數位資產。</p>
